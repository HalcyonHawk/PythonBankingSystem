...
class BankSystem(object):
    ...
    def loadBankData(self):
        ...
        account_no = 90455673
        account_1 = CurrentAccount(account_no, "AdamCurrentAccount", "1234", 5000)
        ...
        account_no += 1
        account_2 = CurrentAccount(account_no, "DavidCurrent", "2601", 3200)
        account_no += 1
        account_3 = SavingsAccount(account_no, "DavidSavings", "2601", 600)
        ...
        account_no += 1
        account_4 = StudentAccount(account_no, "StudentAliceAccount", "1010", 18000)
        ...
        account_no+= 1
        account_5 = CurrentAccount(account_no, "AliMainAccount", "6666", 50)
